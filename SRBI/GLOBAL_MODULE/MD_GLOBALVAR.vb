...
Module MD_GLOBALVAR
    ...
    Public AOQTITLE As String
    Public AOQREFNO As String
    Public AOQDATE As String
    Public AOQNOTEDBY As String
    Public RECB_BY As String
    Public RECB_POS As String
